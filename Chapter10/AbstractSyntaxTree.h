...
BOOST_FUSION_ADAPT_STRUCT(tiger::ast::NameType, (tiger::ast::Identifier, type))

BOOST_FUSION_ADAPT_STRUCT(tiger::ast::Field,
                          (tiger::ast::Identifier, name)(tiger::ast::Identifier,
                                                         type)(bool, escapes))

BOOST_FUSION_ADAPT_STRUCT(tiger::ast::RecordType, (tiger::ast::Fields, fields))

BOOST_FUSION_ADAPT_STRUCT(tiger::ast::ArrayType, (tiger::ast::Identifier, type))
...
BOOST_FUSION_ADAPT_STRUCT(tiger::ast::VarDeclaration,
                          (tiger::ast::Identifier,
                           name)(boost::optional<tiger::ast::Identifier>,
                                 type)(tiger::ast::Expression, init)(bool,
                                                                     escapes))
...
// https://svn.boost.org/trac10/ticket/12331
PUSH_AND_DISABLE_MSVC_WARNING(4003)

BOOST_FUSION_ADAPT_STRUCT(tiger::ast::NilExpression)
...
BOOST_FUSION_ADAPT_STRUCT(tiger::ast::BreakExpression)
                          ...
                          (tiger::ast::Identifier,
                           var)(tiger::ast::Expression,
                                lo)(tiger::ast::Expression,
                                    hi)(tiger::ast::Expression, body)(bool,
                                                                      escapes))
