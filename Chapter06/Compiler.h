...
public:
  ...
  Compiler(ErrorHandler &errorHandler, Annotation &annotation, TempMap &tempMap,
      ...
      m_tempMap(tempMap), m_translator(translator) {
...
private:
  ...
  result_type compile(Translator::Level level,
