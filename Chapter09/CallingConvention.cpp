...
assembly::Instructions CallingConvention::procEntryExit2(const assembly::Instructions &body) const
{
  ...
  auto liveAtExit = rv::concat(calleeSaved, rv::single(returnValue()), rv::single(stackPointer()));
  return ranges::view::concat(body, rv::single(assembly::Operation{{}, {}, liveAtExit}));
}
