   ...
   in
     i
        ...
        checkProgram(program, checkMove(checkReg(regs[0]),
                                  ...
                                  checkExternalCall("stringCompare", checkArg(0, checkString(leftString)) > checkArg(1, checkString(rightString))) > checkMove(checkReg(regs[1]), returnReg()) > checkMove(checkReg(regs[2]), checkImm(0)) >
  ...
  in
   i %1% i
        ...
        checkProgram(program, checkMove(checkReg(regs[0]), checkImm(wordSize())) >
                                  ...
                                  checkExternalCall("initArray", checkArg(0, checkImm(2)) > checkArg(1, checkImm(3))) > // call initArray(array_size, init_val)
