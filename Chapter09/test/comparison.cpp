 ...
 in
   i
        ...
        checkProgram(
          ...
          checkConditionalJump(relation.second, regs[1], regs[2],
                               trueDest), // check condition, jumping to
  ...
  SECTION("string") {
   ...
   in
     i
        ...
        checkProgram(
          program, checkStringInit(leftString, R"("2")"),
        ...
        checkProgram(
          ...
          checkExternalCall(
            ...
            checkArg(0, checkImm(2))
              > checkArg(1,
                         checkImm(3))), // call initArray(array_size, init_val)
