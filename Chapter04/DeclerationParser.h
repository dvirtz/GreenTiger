...
public:
  DeclerationParser(
    ...
    on_success(typeDeclaration, phoenix::bind(annotation, _val, _1));

    on_success(variableDeclaration, phoenix::bind(annotation, _val, _1));

    on_success(functionDeclaration, phoenix::bind(annotation, _val, _1));
