...
void printStatements(std::ostream &ost, const Statements &statements, const int indent /*= 0*/)
{
...
void printStatement(std::ostream& ost, const Statement& statement, const int indent /*= 0*/)
{
  using helpers::match;
...
void printExpression(std::ostream& ost, const Expression& expression, const int indent /*= 0*/)
{
  using helpers::match;
...
RelOp notRel(RelOp op)
{
  switch (op)
  {
    default: assert(false && "Unknown operation");
    case RelOp::EQ: return RelOp::NE;
    case RelOp::NE: return RelOp::EQ;
    case RelOp::LT: return RelOp::GE;
    case RelOp::GE: return RelOp::LT;
    case RelOp::GT: return RelOp::LE;
    case RelOp::LE: return RelOp::GT;
    case RelOp::ULT: return RelOp::UGE;
    case RelOp::UGE: return RelOp::ULT;
    case RelOp::ULE: return RelOp::UGT;
    case RelOp::UGT: return RelOp::ULE;
  }
}
...
RelOp commute(RelOp op)
{
  ...
  {
    default: assert(false && "Unknown operation");
    case RelOp::EQ: return RelOp::EQ;
    case RelOp::NE: return RelOp::NE;
    case RelOp::LT: return RelOp::GT;
    case RelOp::GE: return RelOp::LE;
    case RelOp::GT: return RelOp::LT;
    case RelOp::LE: return RelOp::GE;
    case RelOp::ULT: return RelOp::UGT;
    case RelOp::UGE: return RelOp::ULE;
    case RelOp::ULE: return RelOp::UGE;
    case RelOp::UGT: return RelOp::ULT;
  }
