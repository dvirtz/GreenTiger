...
Compiler::result_type Compiler::
  operator()(const ast::IntExpression & /* exp */) {
  return CompiledExpression{s_intType};
}

Compiler::result_type Compiler::
  operator()(const ast::StringExpression & /* exp */) {
...
Compiler::result_type Compiler::
  operator()(const ast::ArithmeticExpression &exp) {
...
bool Compiler::addToEnv(const ast::Declaration &dec) {
  return helpers::match(dec)(
    [&](const ast::FunctionDeclarations &decs) { return addToEnv(decs); },
    [&](const ast::VarDeclaration &dec) { return addToEnv(dec); },
    [&](const ast::TypeDeclarations &decs) { return addToEnv(decs); });
}
...
Compiler::Environment Compiler::defaultEnvironment() {
  ...
  valueMap["substring"] =
    FunctionType{s_stringType, {s_stringType, s_intType, s_intType}};
