...
void printStatement(std::ostream& ost, const Statement& statement, int indent /*= 0*/)
{
  using helpers::match;
...
void printExpression(std::ostream& ost, const Expression& expression, int indent /*= 0*/)
{
  using helpers::match;
